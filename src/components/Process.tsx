...
const steps = [
  {
    ...
    title: "Исследование",
    description:
      "Анализируем бизнес, рынок и конкурентов. Определяем точки роста и формируем технологическую стратегию.",
  },
  {
    icon: Lightbulb,
    number: "02",
    ...
    description:
      "Проектируем архитектуру продукта, UX/UI и прототипы. Подбираем оптимальный стек технологий и AI-модели под задачи бизнеса.",
  },
  {
    icon: Settings,
    number: "03",
    title: "Разработка",
    description:
      "Итеративная разработка с регулярными демо и прозрачной отчётностью. Параллельная работа над фронтендом, бэкендом и AI-компонентами.",
  },
  {
    icon: Rocket,
    number: "04",
    title: "Запуск и рост",
    description:
      "Запуск, мониторинг и масштабирование продукта. Улучшаем AI-модели на основе реальных данных и оптимизируем ключевые метрики роста.",
  },
];
