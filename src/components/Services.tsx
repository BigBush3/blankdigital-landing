...
const services = [
  ...
  },
  {
    ...
    description:
      "Создаём масштабируемые системы, объединяющие продукты и сервисы в единую управляемую инфраструктуру.",
    features: ["Микросервисы", "API-интеграции", "Единая среда"],
    gradient: "from-indigo-500 to-blue-400",
  },
  {
    icon: Brain,
    title: "AI-решения и интеллектуальные агенты",
    description:
      "Проектируем и внедряем AI-компоненты в цифровые продукты: интеллектуальная аналитика, автоматизация процессов и принятие решений в реальном времени. Разрабатываем автономных AI-агентов для операционной эффективности и роста.",
